  ...
  try {
    ...
    if (util.notEmpty(user)) {
      await Category.create([
        { userId: user?._id, "name": "Food & Groceries", "icon": "🛒", "type": "expense" },
        { userId: user?._id, "name": "Transport", "icon": "🚗", "type": "expense" },
        { userId: user?._id, "name": "Utilities", "icon": "💡", "type": "expense" },
        { userId: user?._id, "name": "Entertainment", "icon": "🎮", "type": "expense" },
        { userId: user?._id, "name": "Health", "icon": "🏥", "type": "expense" },
        { userId: user?._id, "name": "Shopping", "icon": "🛍️", "type": "expense" },
        { userId: user?._id, "name": "Travel", "icon": "✈️", "type": "expense" },
        { userId: user?._id, "name": "Education", "icon": "🎓", "type": "expense" },
        { userId: user?._id, "name": "Rent", "icon": "🏠", "type": "expense" },
        { userId: user?._id, "name": "Salary", "icon": "💰", "type": "income" },
        { userId: user?._id, "name": "Freelance", "icon": "🧑‍💻", "type": "income" },
        { userId: user?._id, "name": "Investment", "icon": "📈", "type": "income" },
        { userId: user?._id, "name": "Gift", "icon": "🎁", "type": "income" }
